...
class KardexService
{
    ...
    {
        $lastRecord = Inventory::where('product_id', $productId, $warehouseId)
    ...
    public function registryEntry($model, array $product, $warehouseId, $detail)
    {
    ...
    public function registryExit($model, array $product, $warehouseId, $detail)
    {
        $lastRecord = $this->getLastRecord($product['id'], $warehouseId);
