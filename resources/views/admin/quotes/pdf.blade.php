...
<body>
    <div class="title">
        Detalle de la Cotizacion #{{ $quote->serie }}-{{ str_pad($quote->correlative, 4, '0', STR_PAD_LEFT) }}
    </div>

    <div>
        <strong>Fecha:</strong> {{ \Carbon\Carbon::parse($quote->date)->format('d/m/Y H:i') }}<br>
    ...
    <div class="total">
        <strong>Total: Q/ {{ number_format($quote->total, 2) }}</strong>
    </div>
</body>
</html>
